      ...
      <div className="Markets w-full">
        ...
        <table className="w-3/5 mx-auto table-auto ">
            ...
            <tbody>
                ...
                {markets.map(({exchangeId,baseSymbol,quoteSymbol,volumeUsd24Hr,priceUsd,volumePercent,tradesCount24Hr,tradingPairs},i) => {
                    return (
                        <tr className="border shadow-xs h-10" key={i}>
                            <td className="text-center">{i+1}</td>
                            <td className="text-left">{exchangeId}</td>
